  ...
  return (
    ...
    <Form 
        ...
        footerText={
            <div className="text-center mb-3">
                <p>Have an account? <Link href="/login" className="text-brand-secondary-500">Sign in</Link></p>
            </div>
        }
    ...
    >
        ...
        <FormRow>
            ...
            <Input defaultValue={state.data.password_confirmation} type="password" id="password_confirmation" name="password_confirmation" required/>
